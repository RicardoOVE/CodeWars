...
HINT I: Can you rearrange the equation fib(n + 2) = fib(n + 1) + fib(n) to find 
fib(n) if you already know fib(n + 1) and fib(n + 2)? Use this to reason what value 
...
def fib(n):
    ...
    fib_for_n = (pow((1+math.sqrt(5))/2,n)-pow((1-math.sqrt(5))/2,n))/math.sqrt(5)
    return int(fib_for_n)
